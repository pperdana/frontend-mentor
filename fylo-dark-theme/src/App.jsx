const App = () => {
  ...
  <section class="section-1">
    ...
    <img class="illustration-intro" src="images/illustration-intro.png" alt="illustration-intro">
    <main>
 ...
 <section class="section-3">
  ...
  <main>
    ...
    <a class="cta-1" href="#">See how Fylo works 
      <svg class="icon" width="16" height="16" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <defs>
            ...
            <filter x="-25%" y="-25%" width="150%" height="150%" filterUnits="objectBoundingBox" id="a">
                ...
                <feColorMatrix values="0 0 0 0 0.384313725 0 0 0 0 0.878431373 0 0 0 0 0.850980392 0 0 0 0.811141304 0" in="shadowBlurOuter1"></feColorMatrix>
            </filter>
        </defs>
        <g fill="none" fill-rule="evenodd">
            <g transform="translate(2 2)">
                <use fill="#000" filter="url(#a)" xlink:href="#b"></use>
                <use class="circle-hover" fill="#62E0D9" xlink:href="#b"></use>
            </g>
            <path d="M8.582 6l-.363.35 1.452 1.4H5.333v.5h4.338L8.22 9.65l.363.35 2.074-2z" fill="#1B2330"></path>
        </g>
    </svg>       
    </a>
  </main>
  ...
  <footer>
    <div class="sign-up">
      ...
      <p>It only takes a minute to sign up and our free starter tier is extremely generous. If you have any 
        ...
        <button class="cta-2" onclick="validateEmail()">Get Started For Free</button>
