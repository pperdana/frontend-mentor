const Card = () => {
  return (
    <>
      ...
      <section className="card card--border-Red">
        ...
        >
          <g fill="none">
            ...
            <g fill="#FF637B">
              <path d="M7.758 5.818h3.685v3.879H7.758zM15.128 5.818h3.685v3.879h-3.685zM22.497 5.818h3.685v3.879h-3.685z"></path>
            </g>
            <path
              fill="#FF637B"
      ...
      <section className="card card--border-Orange">
        ...
        >
          <g fill="none">
            ...
            ></path>
            <g fill="#FFDA2D">
              <path d="M0 18.875h7.625v3.75H0zM6.585 14.81l-5.75-3.75 2.08-3.12 5.75 3.75zM2.915 33.56l-2.08-3.12 5.75-3.75 2.08 3.12z"></path>
            </g>
            <path
              fill="#FDBF00"
      ...
      <section className="card card--border-Blue">
        ...
        >
          <g fill="none">
            ...
            ></path>
            <g fill="#377FD2">
              <path d="M45.125 7.5H56.5v3.75H45.125zM37.625 7.5h3.75v3.75h-3.75zM45.125 22.5H56.5v3.75H45.125zM37.625 22.5h3.75v3.75h-3.75zM37.625 15H56.5v3.75H37.625zM37.625 30H56.5v3.75H37.625z"></path>
            </g>
          </g>
        </svg>
      </section>
